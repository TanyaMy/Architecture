...
namespace Architecture.Presentation.Views.Source
{
    ...
    public sealed partial class SourceMainPage : Page
    {
        ...
        private void ShowArchitecturesFlyoutItem_OnClick(object sender, RoutedEventArgs e)
        {
            var item = _viewModel.SelectedTableItem;

            _viewModel.ShowArchitectures(item);
        }
        ...
        private void TextBox_OnTextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            var filteredArchColletion = _viewModel.FilteredSourcesList;
            var collectionFromSfDataGrid = _viewModel.SourceList;
